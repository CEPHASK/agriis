      ...
      <div className="relative container px-4 mx-auto">
        <div className="max-w-xl xl:max-w-4xl">
          <h1 className="font-heading text-5xl xs:text-6xl md:text-8xl xl:text-10xl font-bold text-gray-900 mb-8 sm:mb-14">
            <span>Agriculture Creates </span>
            <span className="font-serif italic text-blue-600">Wealth</span>
          </h1>
          <div className="md:flex mb-14 max-w-xs sm:max-w-sm md:max-w-none">
            ...
            <div className="max-w-md">
              <p className="md:text-xl text-gray-900 font-semibold">
                <span className="text-blue-500">Agriis</span> is a startup
                that's making the world a better place! We've been working on
                our mission since 2021
              </p>
            </div>
          </div>
          <a
            className="relative group inline-block w-full sm:w-auto py-4 px-6 mb-24 text-white font-semibold rounded-md bg-blue-600 overflow-hidden"
            href="#"
          >
